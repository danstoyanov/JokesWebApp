...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQustion,JokeAnswer")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQustion,JokeAnswer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
